...
//       
 //   }   
    public static void initialize(SortedClockList sortedList, UnsortedClockList unsortedList) {
...
//        for(int i=0;i<sortedList.getLength();i++) {//checking the sorted list
//            System.out.println("sortedList"+sortedList);
//        }
//        for(int i=0;i<unsortedList.getLength();i++) {//checking the unsorted list
